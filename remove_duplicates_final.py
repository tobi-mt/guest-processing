#!/usr/bin/env python3
"""
Final deduplication script to remove duplicate guests.
Keeps the version with a real email address when duplicates exist.
"""
...
def remove_duplicates():
    ...
    for name_lower, ids_str, _, count in duplicate_groups:
    ...
    if remaining_dups:
        print(f"\nWarning: {len(remaining_dups)} duplicate groups still remain:")
